...
PWA는 웹으로 만든 것을 앱처럼 설치하여 사용할 수 있게 한다.
...
PWA 관련 설정을 위해서는 `manifest.json` 파일에서 아래 내용을 수정한다.
...
```json
{
  ...
  "start_url" : "앱아이콘 눌렀을 때 보여줄 메인페이지 경로",
